...
import AdPanels from "../ui/AdPanels";
import BestsellerBookSection from "../BestsellerBookSection";
          ...
          >
            ...
            <Box w={"170px"} backgroundColor={"pink"}>
              <BookCoverAnimation
                reverseFlip={true}
                size="sm"
                cover="https://m.media-amazon.com/images/I/91wzPLb59HL._AC_UL480_FMwebp_QL65_.jpg"
              />
            </Box>
          </HStack>
        </VStack>
      ...
      >
        ...
        <Box w={"170px"} backgroundColor={"pink"}>
          <BookCoverAnimation
            reverseFlip={true}
            size="sm"
            cover="https://m.media-amazon.com/images/I/614Ov2pKMyL._AC_UL480_FMwebp_QL65_.jpg"
          />
        </Box>
        <Box w={"170px"} backgroundColor={"pink"}>
          <BookCoverAnimation
            reverseFlip={true}
            size="sm"
            cover="https://m.media-amazon.com/images/I/81xxSRsPPuL._AC_UL480_FMwebp_QL65_.jpg"
          />
        </Box>
        <Box w={"170px"} backgroundColor={"pink"}>
          <BookCoverAnimation
