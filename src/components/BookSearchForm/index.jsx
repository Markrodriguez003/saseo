...
export function BookSearchForm(props) {
  ...
  // LISTENER CHECKING TO SEE IF USER SUBMITS BOOK SEARCH
  const [handleSearchSubmit, setHandleSearchSubmit] = useState(false);
  ...
  useEffect(() => {
    ...
    if (handleSearchSubmit === true) {
      handleSubmit();
      setHandleSearchSubmit(false);
    }
  }, [handleSearchSubmit])
